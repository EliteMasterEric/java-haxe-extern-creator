...
public class RecordComponentWriter extends BaseWriter {
    /**
     ...
     * @throws IOException
     */
    public static void writeRecordComponent(OutputStream out, RecordComponentElement element, int indent) throws IOException {
